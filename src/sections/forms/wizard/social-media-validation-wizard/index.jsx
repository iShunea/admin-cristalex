...
const steps = ['Add Social Media Post', 'Review'];
...
export default function AddSocialMediaPost() {
  ...
  return (
    <MainCard title="Add Social Media Post">
            ...
            {!errorMessage ? (
              <>
                <Typography variant="h5" gutterBottom>
                  Social Media Post added successfully!
                </Typography>
              </>
            ) : (
